  ...
  $ui.color = {
    /**
        Convert a HEX color string to an RGB
            ...
            var color=$ui.color.hex2rgb('#FF0000');
            // color = [255,0,0]
    ...
    /**
        Convert an RGB array to a HEX color string
            ...
            var color=$ui.color.rgb2hex([255,0,0]);
            // color = '#FF0000'
    ...
    /**
        Convert an RGB array to a HSV array
            ...
            var color=$ui.color.rgb2hsv([255,0,0]);
            // color = [0,100,100]
    ...
    /**
        Convert an HSV array to a RGB array
            ...
            var color=$ui.color.hsv2rgb([0,100,100]);
            // color = [255,0,0]
    ...
    /**
        Convert an RGB array to a HSL array
            ...
            var color=$ui.color.rgb2hsl([255,0,0]);
            // color = [0,100,50]
    ...
    /**
        Convert an HSL array to a RGB array
            ...
            var color=$ui.color.hsl2rgb([0,100,50]);
            // color = [255,0,0]
    ...
    /**
        Convert a HEX color string to a HSL array
            ...
            var color=$ui.color.hex2hsl('#FF0000');
            // color = [0,100,50]
    ...
    /**
        Convert an HSL array to a HEX color string
            ...
            var color=$ui.color.hsl2hex([0,100,50]);
            // color = '#FF0000'
    ...
    hsl2hex: function (hsl) {
      return this.rgb2hex(this.hsl2rgb($ui.toArr(hsl)));
    },

    /**
        Convert an HSV array to HSL array

            var color=$ui.color.hsv2hsl([0,100,100]);
            // color = [0,100,50]
    ...
    hsv2hsl: function (hsv) {
      return this.rgb2hsl(this.hsv2rgb($ui.toArr(hsv)));
    },

    /**
        Convert an HSL array to HSV array

            var color=$ui.color.hsl2hsv([0,100,50]);
            // color = [0,100,100]
    ...
    hsl2hsv: function (hsl) {
      return this.rgb2hsv(this.hsl2rgb($ui.toArr(hsl)));
    },

    /**
        Convert a HEX color string to a HSV array

            var color=$ui.color.hex2hsv('#FF0000');
            // color = [0,100,100]
    ...
    /**
        Convert an HSV array to a HEX color string
            ...
            var color=$ui.color.hsv2hex([0,100,100]);
            // color = '#FF0000'
    ...
    random: function (count, hex1, hex2) {
      ...
      if (hex1 && hex2) {
        ...
        h = $ui.getRand(
          Math.min.apply(Math, [hsv1[0], hsv2[0]]),
          Math.max.apply(Math, [hsv1[0], hsv2[0]])
        );
        s = $ui.getRand(
          Math.min.apply(Math, [hsv1[1], hsv2[1]]),
          Math.max.apply(Math, [hsv1[1], hsv2[1]])
        );
        v = $ui.getRand(
          Math.min.apply(Math, [hsv1[2], hsv2[2]]),
          Math.max.apply(Math, [hsv1[2], hsv2[2]])
        );
      } else {
        h = $ui.getRand(0, 360);
        s = 100;
    ...
    /**
        Generate (palette of) complementary color(s) from passed HEX color string
            ...
            var palette=$ui.color.complement('#FF0000', 'split');
            // palette = ["#80ff00", "#00ffff", "#8000ff"]
			
            var palette=$ui.color.complement('#FF0000', 'double');
    ...
    /**
        Generate triadic color palette
            ...
            var palette=$ui.color.triadic('#FF0000');
    ...
    /**
        Generate a color from a percentage point between two colors
            ...
            var color=$ui.color.percentage(0.5);
            // color = "#f2e600";
    ...
    percentage: function (perc, hex1, hex2) {
      hex1 = hex1 || "#ff0000";
      hex2 = hex2 || "#27ae62";
      var hsv1 = $ui.color.hex2hsv(hex1),
        hsv2 = $ui.color.hex2hsv(hex2);
      return $ui.color.hsv2hex([
        Math.round(hsv1[0] + perc * (hsv2[0] - hsv1[0])),
        Math.round(hsv1[1] + perc * (hsv2[1] - hsv1[1])),
        Math.round(hsv1[2] + perc * (hsv2[2] - hsv1[2])),
      ]);
    },
    /**
        Scale either hue, saturation or value of a color by a percentage amount
		
            var scale=$ui.scale.percentage(0.5);
            // color = "#f2e600";
    ...
    scale: function (hex, perc, type, abs) {
      ...
      perc =
        abs === true
          ? perc * 100
          : adj + ((type === "hue" ? 360 : 100) - adj) * perc;
      return this.hsv2hex([
        type === "hue" ? adj : hsv[0],
        type === "saturation" ? perc : hsv[1],
        type === "value" ? perc : hsv[2],
      ]);
    },
    /**
        Lighten a color by a percentage amount
		
            var color=$ui.color.lighten('#840000', 70);
            // color = "#da0000";
    ...
    /**
        Darken a color by a percentage amount
            ...
            var color=$ui.color.darken('#840000', 70);
            // color = "#da0000";
    ...
    /**
        Saturate a color by a percentage amount
            ...
            var color=$ui.color.saturate('#840000', 70);
            // color = "#820000";
    ...
    /**
        Generate algorithmic color palette
            ...
            var palette=$ui.color.algorithmic ({hex:'#FF0000'});
            // palette = ["#ff0000", "#00ff00", "#0000ff"] 		
		
            var palette=$ui.color.algorithmic ({hex:'#FF0000', count: 5});
            // palette = ["#ff0000", "#ccff00", "#00ff66", "#0066ff", "#cc00ff"]  			
		
            var palette=$ui.color.algorithmic ({hex:'#FF0000', scope: 100, count:4});
            // palette = ["#ff00d4", "#ff0047", "#ff4700", "#ffd500"]

            var palette=$ui.color.algorithmic ({hex:'#FF0000', type:'saturation', scope:50});
      ...
      for (i = 0; i < count; i += 1) {
        ...
        switch (type) {
          case "hue":
            palette.push(
              this.hsv2hex([
                this.degrees(origin, offset, 360) === 360
                  ? 0
                  : this.degrees(origin, offset, 360),
                s,
                v,
              ])
            );
